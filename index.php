          ...
          <section id="a-empresa" class="empresa">
            ...
            <div class="container">
              ...
              <div>
                ...
                <p><?php echo htmlspecialchars_decode($row->resumo); ?></p>
                  ...
                  if(count($meusEnderecos)) :
                    ...
                    foreach ($meusEnderecos as $object) :
                      ...
                      //if($object->o_telefone&&$object->o_email&&$object->o_endereco) :
                        ...
                        $tplAddress .= "<li><div>".(($object->o_telefone) ? "<h2>".$object->o_telefone."</h2>" : '').(($object->o_email) ? "<p>".$object->o_email."</p>" : '').(($object->o_endereco) ? '<p><small>'.$object->o_endereco.'</small></p>' : '')."</div></li>";
