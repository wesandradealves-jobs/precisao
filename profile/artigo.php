<?php
    ...
    if(!isset($_GET['id'])){
        if(isset($_POST['update'])) :
            $stmt = $conn->prepare("INSERT artigos (`titulo`, `url`, `text`, `headers`) VALUES (?, ?, ?, ?)");
            $titulo = $_POST['titulo'];
        ...
        $id = $_GET['id'];
        $stmt = $conn->prepare("SELECT `titulo`, `url`, `text`, `headers` FROM `artigos` WHERE `artigos`.`id` = '".$id."'");
        if($stmt){
            $stmt->execute();
        ...
        if(isset($_POST['update'])) :
            ...
            $stmt = $conn->prepare("UPDATE artigos SET `titulo` = ?, `url` = ?, `text` = ?, `headers` = ? WHERE `artigos`.`id` = '".$id."'");
